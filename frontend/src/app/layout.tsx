...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm0 0v-.75m0 6v.75m9-6.75a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm0 6v7.5m-9-7.5v7.5m0 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm9 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-9-7.5h9" />
      </svg>
    ),
  },
  {
